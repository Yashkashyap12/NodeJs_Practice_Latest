...
const server = http.createServer((req, res) => {
  if (req.url === "/") {
    ...
    req.on("end", () => {
      ...
      const reqObject = Object.fromEntries(params);
      console.log(reqObject);
      // fs.writeFileSync("user.txt", JSON.stringify(reqObject)); // this code block everything
      fs.writeFile("user.txt", JSON.stringify(reqObject), (err) => {
